...
class TestFixedPriceComponent(unittest.TestCase):
    """FixedPriceComponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FixedPriceComponent:
        """Test FixedPriceComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FixedPriceComponent`
        """
        model = FixedPriceComponent()
        if include_optional:
    ...
    def testFixedPriceComponent(self):
        """Test FixedPriceComponent"""
