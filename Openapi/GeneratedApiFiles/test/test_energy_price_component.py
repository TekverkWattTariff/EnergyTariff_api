...
class TestEnergyPriceComponent(unittest.TestCase):
    """EnergyPriceComponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnergyPriceComponent:
        """Test EnergyPriceComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnergyPriceComponent`
        """
        model = EnergyPriceComponent()
        if include_optional:
    ...
    def testEnergyPriceComponent(self):
        """Test EnergyPriceComponent"""
