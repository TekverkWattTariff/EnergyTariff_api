...
class TestPowerPrice(unittest.TestCase):
    """PowerPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerPrice:
        """Test PowerPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerPrice`
        """
        model = PowerPrice()
        if include_optional:
            return PowerPrice(
