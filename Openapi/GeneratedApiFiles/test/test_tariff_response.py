...
class TestTariffResponse(unittest.TestCase):
    """TariffResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TariffResponse:
        """Test TariffResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TariffResponse`
        """
        model = TariffResponse()
        if include_optional:
            return TariffResponse(
                tariff = openapi_client.models.tariff.Tariff(
