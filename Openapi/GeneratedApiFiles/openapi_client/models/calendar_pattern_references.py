...
class CalendarPatternReferences(BaseModel):
    """
    A collection of calendar patterns that defines which days and/or dates to use for an active period.
    """ # noqa: E501
    include: Optional[List[StrictStr]] = Field(default=None, description="A list of calendar patterns to be included in the active period.")
    exclude: Optional[List[StrictStr]] = Field(default=None, description="A list of calendar patterns to be excluded from an active period.")
