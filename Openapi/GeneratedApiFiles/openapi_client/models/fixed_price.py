...
class FixedPrice(BaseModel):
    ...
    components: Optional[List[FixedPriceComponent]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "costFunction", "components"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [FixedPriceComponent.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj
