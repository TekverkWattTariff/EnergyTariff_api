...
class TestTariffsResponse(unittest.TestCase):
    """TariffsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TariffsResponse:
        """Test TariffsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TariffsResponse`
        """
        model = TariffsResponse()
        if include_optional:
            return TariffsResponse(
                ...
                calendar_patterns = [
                    openapi_client.models.calendar_pattern.CalendarPattern(
                        name = '', 
                        frequency = '', 
                        days = [
                            56
