...
class ComponentPrices(BaseModel):
    """
    Time differentiated prices for a price component.
    """ # noqa: E501
    component_id: Optional[StrictStr] = Field(default=None, description="Globally unique identifier", alias="componentId")
    prices: Optional[List[PricePeriod]] = None
    __properties: ClassVar[List[str]] = ["componentId", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": [PricePeriod.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
