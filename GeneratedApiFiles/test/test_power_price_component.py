...
class TestPowerPriceComponent(unittest.TestCase):
    """PowerPriceComponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerPriceComponent:
        """Test PowerPriceComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerPriceComponent`
        """
        model = PowerPriceComponent()
        if include_optional:
            return PowerPriceComponent(
    ...
    def testPowerPriceComponent(self):
        """Test PowerPriceComponent"""
